						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1-1" placeholder="Title"
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Username"
											class="col-xs-10 col-sm-5" name='writer' />
									</div>
								...
								<div class="row">
									<div class="col-xs-12">
										<!-- PAGE CONTENT BEGINS -->
										<h4 class="header green clearfix">여기에 게시글을 작성하세요!</h4>
								...
								<button class="btn btn-lg btn-success">
									<i class="ace-icon fa fa-check"></i> 등록!
								</button>
