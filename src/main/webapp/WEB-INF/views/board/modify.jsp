				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" action="/board/modify" method="post">
							...
							<input type='hidden'  name='type' value='<c:out value="${cri.type}"/>'>
								...
								<div class="form-group">
									...
									<label class="col-sm-6" for="form-field-1-1"> regdate </label>
									<div class="col-sm-9">
										<input type="text" id="form-field-1-1" class="form-control"
											name='regDate'
									...
									<label class="col-sm-6" for="form-field-1-1"> Update
										Date </label>
									<div class="col-sm-9">
										<input type="text" id="form-field-1-1" class="form-control"
											name='updateDate'
								...
								<button  class="btn btn-white btn-warning"
									data-oper='modify'>
									MODIFY
								</button>


								<button class="btn btn-white btn-warning btn-bold" data-oper='remove'>
									<i class="ace-icon fa fa-trash-o bigger-120 orange"></i> <a
										href="/board/modify?bno=<c:out value="${board.bno }"/>">REMOVE</a>
								</button>

								<button class="btn btn-white btn-warning" data-oper='list'>
									LIST
								</button>
		...
		jQuery(function($) {
			...
			if (typeof jQuery.ui !== 'undefined' && ace.vars['webkit']) {
				...
				if (typeof jQuery.ui !== 'undefined') enableImageResize();
					...
					$.getScript("/resources/assets/js/jquery-ui.custom.min.js", function(data, textStatus, jqxhr) {
						enableImageResize()
					});
				}
				 */
