...
<script src="/resources/assets/js/buttons.flash.min.js"></script>
<script src="/resources/assets/js/buttons.html5.min.js"></script>
<script src="/resources/assets/js/buttons.print.min.js"></script>
<script src="/resources/assets/js/buttons.colVis.min.js"></script>
<script src="/resources/assets/js/dataTables.select.min.js"></script>
